...
#file paths
TRAIN_PATH = os.path.join(os.path.dirname(__file__), 'datasets/mt_mudt-ud-train.conllu')
TEST_PATH = os.path.join(os.path.dirname(__file__), 'datasets/mt_mudt-ud-test.conllu')
DEV_PATH = os.path.join(os.path.dirname(__file__), 'datasets/mt_mudt-ud-dev.conllu')
